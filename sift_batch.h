...
#ifndef GPUFEATUREEXTRACTION_SIFT_BATCH_H_
#define GPUFEATUREEXTRACTION_SIFT_BATCH_H_
...
class SIFTGPU_batch
{
	public:
		...
		int* _sift_features_batch( IplImage** img, feature*** feat, int intvls,
						  float sigma, float contr_thr, int curv_thr,
						  int img_dbl, int descr_width, int descr_hist_bins );

		//int sift_features( IplImage* img, feature** feat );

		IplImage** createInitImg_batch( IplImage**, int, float, int );

		IplImage**** buildGaussPyr_batch( IplImage**, int, int, float, int);

		IplImage**** buildDogPyr_batch( IplImage****, int, int, int );

		CvSeq** scaleSpaceExtrema_batch( IplImage****, int, int, float, int, CvMemStorage*,int);
...
#endif /* GPUFEATUREEXTRACTION_SIFT_BATCH_H_ */
