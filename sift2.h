...
//		ExtractKeypointDescriptors* extractKeys;
		...
		int sift_features( IplImage* img, feature** feat,int flag );
		...
		IplImage*** buildGaussPyr( IplImage*, int, int, float, int);//xin

		IplImage*** buildDogPyr( IplImage***, int, int, int);//xin

		CvSeq* scaleSpaceExtrema( IplImage***, int, int, float, int, CvMemStorage*, int);//xin
